...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO  chennai_exhibit_data
    ...
    if ($stmt->execute()) {
        ...
        try {
            ...
            $mail->Subject = "Chennai Exhibition Registration Confirmation";
            $mail->isHTML(true);
            $mail->Body = "
                <h3>Dear $first_name $last_name,</h3>
                <p>Thank you for registering for Chennai Exhibition.</p>
            ...
            $mail->Subject = "New Chennai Exhibition Registration - $first_name $last_name";
            $mail->isHTML(true);
...
if (isset($_GET['delete_id'])) {
    ...
    $stmt->close();
    header("Location: ../tables/chennai_exhibit_table.php");
    exit;
}
?>