...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    header("Location: showimg.php"); // Change to your actual file name
    exit();
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><img src="../../assets/images/gallery/<?php echo $row["img"]; ?>" width="100"></td>
                                            <td><?php echo $row["category"]; ?></td>
                                            <td><?php echo $row["subcategory"]; ?></td>
                                            <td>
    <a href="?delete=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this image?');">
