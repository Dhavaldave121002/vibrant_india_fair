          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="chennai_exhibit_table.php">chennai_exhibit_data</a>
                </li>
              </ul>
            </div>
            <div class="row">
                  ...
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                     ...
                     <a
                       ...
                       href="../data_csv/delhi_exhibit_csv.php"  onclick="event.preventDefault();
                $.notify({
                                      ...
                                      echo '<tr>
                                          ...
                                          <td>
                                              <div class="form-button-action">
                                                  <a href="../exhibit/delhi_exhibit_data.php?delete_id=' . $row['id'] . '" class="btn btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this record?\');">
