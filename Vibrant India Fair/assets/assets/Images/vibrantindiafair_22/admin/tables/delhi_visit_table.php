        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">delhi_visit_data</h3>
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="chennai_visit_table.php">chennai_visit_data</a>
                </li>
              </ul>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center">
                      <h4 class="card-title">delhi_visit_data</h4>
                      <a
                      ...
                      <table id="visitorTable" class="display table table-striped table-hover">
                          ...
                          <tbody>
                            <?php  
                              ...
                              $sql = "SELECT * FROM delhi_visit_data";
                                      ...
                                      echo '<tr>
                                          ...
                                          <td>
                                              <div class="form-button-action">
                                                  <a href="../visitor/delhi_visit_data.php?delete_id=' . $row['id'] . '" class="btn btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this record?\');">
