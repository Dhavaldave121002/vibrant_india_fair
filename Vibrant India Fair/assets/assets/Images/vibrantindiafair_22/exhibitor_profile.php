        ...
        <div class="showcase-banner-main-box">
            <div class="showcase-banner-thumbnail">
                <div class="showcase-banner-img-box">
                    <picture> 
                        <img class="showcase-banner-img" src="https://satte.in/UIComponents/images/innerbanner.jpg" alt="">
                    </picture>
                </div>
                <div class="banner-header-title">EXHIBITOR PROFILE</div>
            </div>
        </div>
    </section>
    <!-- ----- End Banner Section ----- -->
    ...
    <section class="section-margin">
        <div class="main main-div">
            <div class="container-fluid">
                <div class="primary-heading">Exhibitor Profile</div>
                <div class="row">
