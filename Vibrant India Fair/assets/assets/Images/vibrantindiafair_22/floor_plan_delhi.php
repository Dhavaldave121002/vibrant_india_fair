...
<body>
        ...
        <div class="showcase-banner-main-box">
            <div class="showcase-banner-thumbnail">
                <div class="showcase-banner-img-box">
                    <picture>
                    <img class="showcase-banner-img" src="assets/images/floor-plan-banner.jpg" alt="">
                </picture>
                </div>
                <div class="banner-header-title">FLOOR PLAN DELHI</div>
            </div>
        </div>
    </section>
    <!-- --- End Baneer Section --- -->
    ...
    <!-- --- How to design your exhibitor floor plan & layout --- -->
     <section class="section-margin">
        <div class="delhi-floor-plan-design-back-img-body">
            <div class="container">
                <div class="delhi-floor-plan-design-heading-box">
                    <div class="delhi-floor-plan-design-heading">
                        How to design your exhibitor floor plan & layout
                    </div>
                </div>
            </div>
        </div>
        <div class="delhi-floor-plan-design-text-content-body">
            <div class="container">
                <div class="delhi-floor-plan-design-text-content">
    ...
    <!-- --- End How to design your exhibitor floor plan & layout --- -->

    <!-- --- Floor Plan Delhi ---  -->
     <section class="section-margin">
        <div class="container">
            <div class="delhi-floor-plan-delhi-body">
                <div class="delhi-floor-plan-delhi-img-box">
                    <img class="delhi-floor-plan-delhi-img" src="assets/images/floor-plan-delhi.jpg" alt="">
                </div>
            </div>
        </div>
     </section>
    <!-- --- End Floor Plan Delhi ---  -->
    <?php 
